...
## [ft_memset](ft_libft/ft_memset.c)
...
:-----------: | :-----------: | :-----------: | :-----------:
 ...
 ## [ft_memcpy](ft_libft/ft_memcpy.c)
...
Copies n bytes from memory area src to memory of dst. The memory  areas  must  not  overlap.  Use [ft_memmove](#ft_memmove) if the memory areas do overlap.| Memory area dst | Memory area src | The number of bytes | A pointer to the memory area dst
 ...
 ## [ft_memccpy](ft_libft/ft_memccpy.c)
...
## [ft_memmove](ft_libft/ft_memmove.c)
...
Scans the initial n bytes of s for the first instance of c | Memory area s| A character to search | The number of bytes | A pointer to the matching byte or NULL if the character does not occur in the given memory area
 ...
 ## [ft_memcmp](ft_libft/ft_memcmp.c)
...
## [ft_strlen](ft_libft/ft_strlen.c) 
...
## [ft_strdup](ft_libft/ft_strdup.c) 
...
## [ft_strrchr](ft_libft/ft_strrchr.c)
...
## [ft_strcpy](ft_libft/ft_strcpy.c)
...
## [ft_strlcpy](ft_libft/ft_strlcpy.c)
...
## [ft_strcat](ft_libft/ft_strcat.c)
...
## [ft_strlcat](ft_libft/ft_strlcat.c)
...
## [ft_strstr](ft_libft/ft_strstr.c)
...
## [ft_strnstr](ft_libft/ft_strnstr.c)
...
## [ft_isalpha](ft_libft/ft_isalpha.c)
...
## [ft_isdigit](ft_libft/ft_isdigit.c)
...
## [ft_isalnum](ft_libft/ft_isalnum.c)
...
## [ft_isascii](ft_libft/ft_isascii.c)
...
## [ft_isprint](ft_libft/ft_isprint.c)
...
## [ft_toupper](ft_libft/ft_toupper.c)
...
## [ft_tolower](ft_libft/ft_tolower.c)
...
## [ft_calloc](ft_libft/ft_calloc.c)
...
## [ft_substr](ft_libft/ft_substr.c)
...
## [ft_strjoin](ft_libft/ft_strjoin.c)
...
## [ft_strtrim](ft_libft/ft_strtrim.c)
...
## [ft_strmapi](ft_libft/ft_strmapi.c)
